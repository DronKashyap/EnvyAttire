...
//   try {
//     const response = await axios.get(`https://asos10.p.rapidapi.com/api/v1/getProductDetails?productId=${productId}`, {
//       headers: {
//         'x-rapidapi-host': 'asos10.p.rapidapi.com',
//         'x-rapidapi-key': process.env.NEXT_PUBLIC_DATA_API_KEY,
//       },
...
//     const productinfo = response.data.data.map((product: any) => ({
//       productId: product.id,
//       name:product.name,
//       price: product.price.current.value,
