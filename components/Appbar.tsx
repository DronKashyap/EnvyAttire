...
export default function Appbar() {
    ...
    return (
        <div className="flex justify-around items-center hover:text-red-500 font-extrabold backdrop-blur-md font-serif  w-full absolute z-10 h-10 hover:bg-white">
            ...
            EnvyAttire</div>
            <h1 className='p-2 backdrop-blur-3xl mr-1 shadow-black  shadow-inner hover:text-red-900 hover:shadow-none rounded-md'>Home</h1>
            <h1 className='p-2 backdrop-blur-3xl mr-1 shadow-black  shadow-inner hover:text-red-900 hover:shadow-none rounded-md'>About</h1>
            {/* <BrandsDropdown /> */}
            <div className="flex"> 
